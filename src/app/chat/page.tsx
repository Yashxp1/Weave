...
const Chat = () => {
  return (
    <div className="flex h-screen w-full  bg-white dark:bg-[#181818]">
      <div className="w-1/4 dark:bg-[#181818] border border-[#D5D5D5] dark:border-[#2D2D2D] p-4 border-r flex flex-col">
