...
const Card = () => {
  return (
    <div className="bg-white transition-all border-[#D5D5D5] dark:bg-[#181818]  w-[90%] lg:w-[60%] rounded-4xl border dark:border-[#2D2D2D]">
      ...
      <div className="border border-[#D5D5D5]  dark:border-[#2D2D2D]"></div>
    </div>
  );
};
